...
class InquiryManager {
    ...
    try {
        ...
        console.log('pendingDocId:', inquiry?.pendingDocId); // ADD THIS
        console.log('accountInfo.uid:', inquiry?.accountInfo?.uid); // ADD THIS
        ...
        if (inquiry?.accountInfo?.uid) {
            if (inquiry?.pendingDocId) {
                ...
                console.log('Updated existing pending document');
            } else {
                console.log('NO PENDINGDOCID FOUND - this is the problem!');
                // For now, just update main inquiry
            }
        }
